              ...
              <?php
               ...
               <?php
                ...
                <?php
                    ...
                    $subscriber_user_count=mysqli_num_rows($subscriber_user);
                ?>
                    ...
                    google.charts.load('current', {'packages':['bar']});
                      ...
                      function drawChart() {
                        ...
                        <?php
                            ...
                            $element_count=[$post_count,$draft_post_count,$comments_count,$unapproved_comment_count,$users_count,$subscriber_user_count,$categories_count];
                            for($i=0;$i<7;$i++){
